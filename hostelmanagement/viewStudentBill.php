...
if (strlen($_SESSION['studentsession']==0)) {
    	...
    	if(isset($_POST['add']))
  {
    ...
    $toDate=$_POST['toDate'];
	$get=mysqli_query($con,"SELECT COUNT(attendStatus) AS STATUS,studentName,usn,sem FROM attend_tbl INNER JOIN student_tbl ON attend_tbl.studentId=student_tbl.studentId WHERE attendStatus = 'P' AND attend_tbl.studentId=$studentId and (attendDateTime between '$fromDate' and '$toDate')");
	foreach($get as $Data):
		...
		<div class="container">
			<div class="wthree_about_grids">
				<div class="col-md-8 wthree_about_grid_left">
					...
					<input type="submit"  name="add" id="add" value="View Bill">
				</form>
	</div>
