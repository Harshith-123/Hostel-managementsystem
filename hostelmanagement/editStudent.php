...
if (strlen($_SESSION['adminsession']==0)) {
	...
	if(isset($_POST['add']))
  {
    ...
    $mailId=$_POST['mailId'];
	$usn=$_POST['usn'];
	$get1=mysqli_query($con,"select * from student_tbl where (mailId='$mailId' or usn='$usn') and studentId!=$id");
    ...
    $query=mysqli_query($con,"update student_tbl set studentName = '$name',mailId = '$mailId',mobile = '$mobile' ,usn = '$usn' ,address = '$address' ,sem = '$sem',parentName = '$parentName' where studentId=$id");
    //echo $query."print";
...
$get=mysqli_query($con,"select * from student_tbl where studentId=$hId");
  foreach($get as $Data):
...
<br>
					...
					<div class="form-group">
                        ...
                        <input type="text" class="form-control" id="Name" value="<?php echo $studentName;?>" name="Name" placeholder="Student  Name" tabindex="1">
                    </div>
					<br>
					<br>
					<div class="form-group">
                        <label class="form-label" id="nameLabel" for="name">Student MailId</label>
                        <input type="text" class="form-control" value="<?php echo $mailId;?>" id="mailId" name="mailId" placeholder="Student MailId" tabindex="1">
                    </div>
					<br>
					<br>
					<div class="form-group">
                        <label class="form-label" id="nameLabel" for="name">Student Mobile Number</label>
                        <input type="text" class="form-control" value="<?php echo $mobile;?>" id="mobile" name="mobile" placeholder="Student Mobile Number" tabindex="1">
                    </div>
					<br>
					<br>
					<div class="form-group">
                        <label class="form-label" id="nameLabel" for="name">Student USN</label>
                        <input type="text" class="form-control" id="usn" value="<?php echo $usn;?>" name="usn" placeholder="Student USN Number" tabindex="1">
                    </div>
					<br>
					<br>
					<div class="form-group">
                        <label class="form-label" id="nameLabel" for="name">Student Address</label>
                        <input type="text" class="form-control" id="address" value="<?php echo $address;?>" name="address" placeholder="Student Address" tabindex="1">
                    </div>
					<br>
					<br>
					<div class="form-group">
                        <label class="form-label" id="nameLabel" for="name">Parent Name</label>
                        <input type="text" class="form-control" value="<?php echo $parentName;?>" id="parentName" name="parentName" placeholder="Parent Name" tabindex="1">
                    </div>
					<br>
					<br>
					<div class="form-group">
                        <label class="form-label" id="nameLabel" for="name">SEM</label>
                        <input type="number" class="form-control"  value="<?php echo $sem;?>" id="sem" name="sem" placeholder="Student sem" min="1" max="8" tabindex="1">
                    </div>
					<br>
					<br>
