...
<div class="col-md-7 contact-right-w3l">
				...
				<?php
				$count=1;
				$c=mysqli_query($con,"SELECT * FROM student_tbl");              
				foreach($c as $r):
				$studentName=$r['studentName'];
				$gender=$r['gender'];
				$id=$r['studentId'];
				$query=mysqli_query($con,"select * from allot_tbl where studentId=$id");
				if(mysqli_num_rows($query)==0){
				?>
				 <table class="table table-bordered mt-7">
		<tr>
                    <th colspan="6">Hostel Details</th>
                </tr>
                <tr>
                    <th>#</th>
                    <th>Student Name: </th>
				...
				<tr>
                    ...
                    <td><?=$studentName; ?></td>
                    <td><?=$gender; ?></td>
					<td><a href="editedallotrooms.php?allotId=<?php echo $r['studentId'];?>">Allot Rooms</a>
						</td>
...
?>
<h1>No Data Available/Students already alloted to room</h1>
<?php
				}
$count+=1;
endforeach;
