...
<body>
			...
			<nav class="navbar agileits w3layouts navbar-default">
				...
				<div class="navbar-collapse agileits w3layouts collapse hover-effect" id="navbar">
					<ul class="agileits w3layouts">
						...
						<li class="agileits w3layouts"><a  href="viewHostel.php">View Hostel Fee</a></li>
  ...
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col">Hostel PhoneNumber</th>
    </tr>
  </thead>
  <tbody>
  <?php 
  $count=1;
  $get=mysqli_query($con,"select * from room_tbl inner join hostel_tbl on room_tbl.hostelId=hostel_tbl.hostelId inner join allot_tbl on room_tbl.roomId=allot_tbl.roomId where allot_tbl.studentId=$studentId");
  foreach($get as $Data):
	$hName=$Data['hostelName'];
	$hAddress=$Data['hostelAddress'];
	$hMobile=$Data['hostelMobile'];
